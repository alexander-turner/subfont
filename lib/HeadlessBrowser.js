...
async function downloadOrLocatePreferredBrowserRevision() {
  ...
  return puppeteer.launch({
    ...
    // Hack: Avoid this error on CI:
    // Error: Failed to launch the browser process!
    // [0321/172409.186799:FATAL:zygote_host_impl_linux.cc(127)] No usable sandbox! Update your kernel or see https://chromium.googlesource.com/chromium/src/+/main/docs/linux/suid_sandbox_development.md for more information on developing with the SUID sandbox. If you want to live dangerously and need an immediate workaround, you can try using --no-sandbox.
