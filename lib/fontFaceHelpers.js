...
function getUnusedVariantsStylesheet(
  ...
  return accumulatedFontFaceDeclarations
    ...
    .map((props) => {
      ...
      let rule = `@font-face{font-family:${props['font-family']}__subset;font-stretch:${props['font-stretch']};font-style:${props['font-style']};font-weight:${props['font-weight']};src:${src}`;
