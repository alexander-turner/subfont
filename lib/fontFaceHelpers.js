...
function getUnusedVariantsStylesheet(
  ...
  return accumulatedFontFaceDeclarations
    ...
    .map((props) => {
      ...
      return `@font-face{font-family:${maybeCssQuote(`${props['font-family']}__subset`)};font-stretch:${props['font-stretch']};font-style:${props['font-style']};font-weight:${props['font-weight']};src:${src}}`;
    })
    .join('');
}
...
const md5HexPrefix = hashHexPrefix;
const cssQuoteIfNecessary = maybeCssQuote;
