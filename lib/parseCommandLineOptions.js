module.exports = function parseCommandLineOptions(argv) {
  ...
  yargs
    ...
    .options('skip-source-map-processing', {
      alias: ['skipSourceMapProcessing'],
      describe:
        'Skip CSS source map processing for faster execution. Disable with --no-skip-source-map-processing if you need source maps preserved through subfont',
      type: 'boolean',
      default: true,
    })
