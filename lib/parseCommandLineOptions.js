module.exports = function parseCommandLineOptions(argv) {
  ...
  yargs
    ...
    .options('fast', {
      describe:
        'Skip redundant font-tracing for pages sharing identical CSS. Trades per-page subset precision for speed (all text assigned to all fonts on fast-path pages)',
      type: 'boolean',
      default: false,
    })
    .options('source-maps', {
