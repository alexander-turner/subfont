...
//
// Limitation: this only checks rules that explicitly declare font-family in the
// same rule as feature settings. CSS inheritance (parent sets font-family, child
// sets font-feature-settings) is handled conservatively: if a rule has feature
// settings but no font-family, we assume ALL fonts may need feature processing.
