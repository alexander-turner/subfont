...
async function collectTextsByPage(
  ...
  return { htmlOrSvgAssetTextsWithProps, fontFaceDeclarationsByHtmlOrSvgAsset, subTimings };
}
...
async function subsetFonts(
  ...
  debugLog(
    console,
    debug,
    `[subfont timing] populate (google fonts): ${timings['populate (google fonts)']}ms`
  );
  ...
  const { htmlOrSvgAssetTextsWithProps, fontFaceDeclarationsByHtmlOrSvgAsset, subTimings } =
