...
const { logPhaseStart } = require('./progress');
...
async function subsetFonts(
  ...
  const subsetPhase = logPhaseStart(console, debug, 'getSubsetsForFontUsage');
  ...
  const insertPhase = logPhaseStart(
    console,
    debug,
  ...
  const injectPhase = logPhaseStart(
    console,
    debug,
    'inject subset font-family into CSS/SVG'
  );
