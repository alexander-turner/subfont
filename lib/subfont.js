...
module.exports = async function subfont(
  ...
  const rows = [
    ...
    ['collectTextsByPage', subsetTimings.collectTextsByPage, 1],
    ...
    ['codepoint generation', subsetTimings['codepoint generation'], 1],
    ['getSubsetsForFontUsage', subsetTimings.getSubsetsForFontUsage, 1],
    ['insert subsets loop', subsetTimings['insert subsets loop'], 1],
    ['inject font-family', subsetTimings['inject subset font-family'], 1],
