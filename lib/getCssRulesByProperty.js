...
function getCssRulesByProperty(properties, cssSource, existingPredicates) {
  ...
  // Not collapsing duplicate values into a single object. Duplicate
  // property declarations (e.g., from different rules or specificity
  // levels) must be preserved individually so that the cascade and
  // specificity resolution in the consuming code works correctly.
  // Merging them here would lose source order and specificity information.
